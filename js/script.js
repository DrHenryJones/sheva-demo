  ...
  */
  if (childAggregation != undefined) {
    if (childAggregation == 'mean') {
      JSONTree["hypothesis"] = "μ > 4";
    } else if (childAggregation == 'variance') {
      JSONTree["hypothesis"] = "σ² < 1";
    } else {
      JSONTree["hypothesis"] = "R ≁ U";
    }
  } else {
        ...
        for (let i = 0; i < currentOperatorResults[activeIndex].length; i++) {
            ...
            if (currentDataset == 'MovieLens') {
              ...
              `<!-- Ratings -->
                  ...
                  <div>
                    <canvas id="${currentOperatorResults[activeIndex][i]['heading_id']}OperationsChart"></canvas>
                  </div>
                  
                  <script>
                  
                    new Chart(document.getElementById("${currentOperatorResults[activeIndex][i]['heading_id']}OperationsChart"), {
                      type: 'bar',
                      data: {
                      labels: ['unique', '+', 'x', '/', '-'],
                      datasets: [{
                        label: 'Answer counts',
                        backgroundColor: ['#1f77b4', '#ff7f0e'],
                        data: [${currentOperatorResults[activeIndex][i]['operation']}],
                        borderWidth: 1
                      }]
                    },
                      options: {
                  ...
                  <div>
                    <canvas id="${currentOperatorResults[activeIndex][i]['heading_id']}OperandsChart"></canvas>
                  </div>
                  
                  <script>
                  
                    new Chart(document.getElementById("${currentOperatorResults[activeIndex][i]['heading_id']}OperandsChart"), {
                      type: 'bar',
                      data: {
                      labels: ['1', '2'],
                      datasets: [{
                        label: 'Answer count',
                        backgroundColor: ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', '#9467bd', '#8c564b', '#e377c2'],
                        data: [${currentOperatorResults[activeIndex][i]['operands']}],
                        borderWidth: 1
                      }]
                    },
                      options: {
                  ...
                  <div>
                    <canvas id="${currentOperatorResults[activeIndex][i]['heading_id']}VisualizationsChart"></canvas>
                  </div>
      
                  <script>
      
                    new Chart(document.getElementById("${currentOperatorResults[activeIndex][i]['heading_id']}VisualizationsChart"), {
                      type: 'bar',
                      data: {
                      labels: ['division-visualization-baskets', 'multiplication-visualization-field', 'number-line-answer', 'object-counting', 'object-counting-with-numbers', 'object-selection-answer', 'written-question'],
                      datasets: [{
                        label: 'Answer count',
                        backgroundColor: ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', '#9467bd', '#8c564b', '#e377c2'],
                        data: [${currentOperatorResults[activeIndex][i]['visualization']}],
                        borderWidth: 1
                      }]
                    },
                      options: {
                  ...
                  <div>
                    <canvas id="${currentOperatorResults[activeIndex][i]['heading_id']}SkillsLvl1Chart"></canvas>
                  </div>
      
                  <script>
      
                    new Chart(document.getElementById("${currentOperatorResults[activeIndex][i]['heading_id']}SkillsLvl1Chart"), {
                      type: 'bar',
                      data: {
                      labels: ['1870', '1893', '2076', '2234', '2018'],
                      datasets: [{
                        label: 'Answer count',
                        backgroundColor: ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', '#9467bd'],
                        data: [${currentOperatorResults[activeIndex][i]['skill_lvl_1']}],
                        borderWidth: 1
                      }]
                    },
                      options: {
